...
struct SceneKitParticlesView: NSViewRepresentable {
    func makeNSView(context: Context) -> SCNView {
        ...
        let colors: [NSColor] = [
            NSColor(red: 1, green: 230/255, blue: 140/255, alpha: 1),
            NSColor(red: 1, green: 190/255, blue: 95/255, alpha: 0.7),
            NSColor(red: 200/255, green: 223/255, blue: 255/255, alpha: 0.8)
        ]
...
#elseif os(iOS)
struct SceneKitParticlesView: UIViewRepresentable {
    func makeUIView(context: Context) -> SCNView {
        ...
        let colors: [UIColor] = [
            UIColor(red: 1, green: 230/255, blue: 140/255, alpha: 1),
            UIColor(red: 1, green: 190/255, blue: 95/255, alpha: 0.7),
            UIColor(red: 200/255, green: 223/255, blue: 255/255, alpha: 0.8)
        ]
    ...
    func createWarmColorParticleSystem(color: UIColor) -> SCNParticleSystem {
        let particleSystem = SCNParticleSystem()
        particleSystem.particleSize = CGFloat.random(in: 0.05...0.2)
        particleSystem.particleImage = UIImage(named: "Particle")
        particleSystem.particleColor = color
        particleSystem.particleColorVariation = SCNVector4(0.1, 0.1, 0.1, 0.5)
        particleSystem.emitterShape = SCNPlane()
        particleSystem.birthRate = 100
